...
$select_unread = "SELECT * FROM messages WHERE status=0";
$select_messages = mysqli_query($db_connect, $select_unread);

$count_msg = "SELECT COUNT(*) as total FROM messages WHERE status=0";
$select_count= mysqli_query($db_connect, $count_msg);
$after_assoc_count = mysqli_fetch_assoc($select_count);
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <link href="/Dominy/dashboard_asset/vendor/summernote/summernote.css" rel="stylesheet">
    <!-- Custom Stylesheet -->
	<link href="/Dominy/dashboard_asset/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="/Dominy/dashboard_asset/images/logo.png" alt="">
                <img class="logo-compact" src="/Dominy/dashboard_asset/images/logo-text.png" alt="">
                <img class="brand-title" src="/Dominy/dashboard_asset/images/logo-text.png" alt="">
            </a>
                        ...
                        <ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link  ai-icon" href="javascript:void(0)" role="button" data-toggle="dropdown">
									...
									<div class="pulse-css"><?=$after_assoc_count['total']?></div>
                                </a>
                                <div class="dropdown-menu rounded dropdown-menu-right">
                                    <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380">
										<ul class="timeline">
											...
											foreach($select_messages as $mess) {?>
											<li>
												<a href="../contact/msg_view.php?id=<?=$mess['id']?>">
												<div class="timeline-panel bg-light">
													<div class="media-body">
														<h6 class="mb-1">Dr <?=$mess['name']?> Send you a Message</h6>
														<small class="d-block"><?=date($mess['date'])?></small>
													</div>
												 </div>
												</a>
											</li>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                       <?php if($after_assoc['photo'] == null) {?>
										<img src="/Dominy/Dashboard_asset/images/profile/17.jpg" width="20" alt=""/>
										<?php } else{?>
										<img src="/Dominy/upload/user/<?=$after_assoc['photo']?>" width="20" alt=""/>
										<?php }?>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="/Dominy/user/profile.php" class="dropdown-item ai-icon">
                                        <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                        <span class="ml-2">Profile </span>
                                    </a>
                                    <a href="/Dominy/logout.php" class="dropdown-item ai-icon">
				...
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li><a href="/Dominy/dashboard.php">Dashboard</a></li>
						</ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/Dominy/user/user.php">Users List</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
						   <li><a href="/Dominy/logos/logo.php">Add New Logos</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
						   <li><a href="/Dominy/menu/menu.php">Add New Menu</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
						   <li><a href="/Dominy/banner/banner_info.php">Edit Banner Information</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
						   <li><a href="/Dominy/about/about.php">Edit About Information</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
						   <li><a href="/Dominy/service/service.php">Add New Service</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
						   <li><a href="/Dominy/team/team_info.php">Add Team Information</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
						   <li><a href="/Dominy/portfolio/portfolio.php">Add Portfolio</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
						   <li><a href="/Dominy/counter/counter.php">Add Counter</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
						   <li><a href="/Dominy/testimonial/test.php">Add Testimonial</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
						   <li><a href="/Dominy/contact/contact.php">Messages List</a></li>
                        </ul>
                    </li>
			</div>
        </div>
